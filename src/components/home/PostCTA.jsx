    ...
    <section className="bg-[#292924] py-24 px-6 relative z-20 mt-0 pb-32">
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-black rounded-[40px] p-10 md:p-14 flex flex-col h-full">
            ...
            <button 
              ...
              className="flex items-center gap-2 group/btn font-bold text-[14px] text-white border border-white/20 px-6 py-3 rounded-full w-fit hover:bg-white hover:text-black transition-all cursor-pointer"
            >
          ...
          <div className="bg-black rounded-[40px] p-10 md:p-14 flex flex-col h-full">
            ...
            <Link 
              to="/product"
              className="flex items-center gap-2 group/btn font-bold text-[14px] text-white border border-white/20 px-6 py-3 rounded-full w-fit hover:bg-white hover:text-black transition-all"
            >
        ...
        <div className="bg-black rounded-[32px] md:rounded-full p-6 px-10 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <Link 
            to="/integrations"
            className="flex items-center gap-2 group/banner font-bold text-[14px] text-white border border-white/20 px-8 py-2.5 rounded-full hover:bg-white hover:text-black transition-all whitespace-nowrap"
          >
